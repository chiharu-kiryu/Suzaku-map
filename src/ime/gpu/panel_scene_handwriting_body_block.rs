{
                    ...
                    let handwriting_status_y = handwriting_y + 6.0 * responsive_scale;
                    let handwriting_hint_y = handwriting_y + 30.0 * responsive_scale;
                    let handwriting_footer_rect = [
                        drawer_rect[0] + 10.0 * responsive_scale,
                        drawer_rect[1] + drawer_rect[3] - 32.0 * responsive_scale,
                        drawer_rect[2] - 20.0 * responsive_scale,
                        22.0 * responsive_scale,
                    ];
                    let canvas_top = handwriting_y + 50.0 * responsive_scale;
                    let canvas_rect = [
                        drawer_rect[0],
                        canvas_top,
                        drawer_rect[2],
                        (handwriting_footer_rect[1] - 8.0 * responsive_scale - canvas_top)
                            .max(104.0 * responsive_scale),
                    ];
                    ...
                    let handwriting_layouts = vec![
                        TextBlock {
                            ...
                            max_width: drawer_rect[2] - 160.0 * responsive_scale,
                            pixel_size: title_px,
                        ...
                        TextBlock {
                            ...
                            origin: [
                                drawer_rect[0] + drawer_rect[2] - 126.0 * responsive_scale,
                                handwriting_status_y,
                            ],
                            max_width: 112.0 * responsive_scale,

                    ...
                    let voice_footer_height =
                        (voice_footer_rows as f32 * 24.0 + 8.0) * responsive_scale;
                    let voice_footer_rect = [
                        drawer_rect[0] + 10.0 * responsive_scale,
                        voice_rect[1] + voice_rect[3] - voice_footer_height - 6.0 * responsive_scale,
                        drawer_rect[2] - 20.0 * responsive_scale,
                        voice_footer_height,
                    ];
                    let voice_content_x = voice_rect[0] + 12.0 * responsive_scale;
                    let voice_header_y = voice_y + 10.0 * responsive_scale;
                    let voice_transcript_y = voice_y + 44.0 * responsive_scale;
                    let voice_transcript_bottom =
                        voice_footer_rect[1] - 12.0 * responsive_scale;
                    let voice_transcript_max_lines = if voice_transcript_bottom - voice_transcript_y
                        >= 30.0 * responsive_scale
                    {
                        2
                    } else {
                        1
